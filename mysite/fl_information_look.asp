...
<div align="center">
<input type="button" class="btns" onclick="location='found_lost_information.asp'"   onMouseOver="this.style.backgroundPosition='left -40px'" onMouseOut="this.style.backgroundPosition='left top'"  value="返回"  />
</div>
</body>
</html>
