...
<br>
<form id="theForm" name="theForm" method="post" action="grade_information_bottom.asp" target="grade_bottom">
  学期：
	  <label>
	      <%
...
<label>
<input name="noorname" class="inputsearch" value="请输入学号或课程名" type="text" onclick="this.value=''"  onblur="if(this.value=='')this.value='请输入学号或课程名';"/>
</label>
      <label>
