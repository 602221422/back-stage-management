...
if ( !this.ParentWindow ){
	...
	arr.push("        <input  type='hidden' id='_ButtonOK_"+this.ID+"'   value=''>   	");
	arr.push("           	<input  type='hidden' id='_ButtonCancel_"+this.ID+"'  onclick=\"Dialog.getInstance('"+this.ID+"').close();\" value=''>");
	arr.push("            </div></td></tr>");
